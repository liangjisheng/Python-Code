...
def make_omelet(omelet_type):
	...
	that contains all of the ingredients for you omelet, or provide
	...
	if type(omelet_type) == type({}):
		...
		omele_ingredients = get_omelet_ingredients(omelet_type);
		return make_food(omele_ingredients, omelet_type);
	else:
